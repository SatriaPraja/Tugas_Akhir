...
<head>
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        primary: '#1E3A8A', // Deep Blue (Warna Utama)
                        secondary: '#3B82F6', // Sky Blue (Aksen)
                        darkBlue: '#172554', // Navy untuk teks/hover
                    },
                    keyframes: {
                        fadeInUp: {
                            '0%': {
    ...
    <style>
        ...
        /* Background subtle map pattern atau gradient */
        body {
...
<body class="font-sans antialiased flex items-center justify-center min-h-screen p-4">
    <div class="w-full max-w-lg">
        ...
        <div class="text-center mb-8 animate-fade-in-up">
            ...
            <p class="text-gray-600 mt-2 text-sm font-medium tracking-wide uppercase">
                Desa Klapagading
            </p>
        </div>
        ...
        <div
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-400 text-sm">Gunakan akun Anda untuk mengakses sistem klasterisasi</p>
            </div>
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-5 relative">
                    <label class="block text-xs font-bold text-primary uppercase mb-1 ml-1">Email / Username</label>
                    <div class="relative">
                ...
                <div class="mb-8 relative">
                    <label class="block text-xs font-bold text-primary uppercase mb-1 ml-1">Kata Sandi</label>
                    <div class="relative">
